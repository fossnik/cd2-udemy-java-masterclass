...
public class Main {
    ...
    public static void main(String[] args) {
		...
		additions.put("cheese", 50);
		additions.put("pickle", 65);
		additions.put("chips", 100);
		additions.put("coke", 200);

		Hamburger hamburger = new Hamburger("Classic", 500, "white", "beef", "cheese");
		...
		System.out.println("Total Burger price is " + hamburger.itemizeHamburger());s
    }
}
