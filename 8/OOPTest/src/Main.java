public class Main {
	...
	public static void main(String[] args) {
		...
		// We want to create a base hamburger, but also two other types of hamburgers that are popular ones
		...
		double price = hamburger.printReceipt();
		hamburger.addHamburgerAddition1("Tomato", 0.27);
		hamburger.addHamburgerAddition2("Lettuce", 0.75);
		hamburger.addHamburgerAddition3("Cheese", 1.13);
		System.out.println("Total Burger price is " + hamburger.printReceipt());

		HealthyBurger healthyBurger = new HealthyBurger("Bacon", 5.67, "White", "Pork");
		healthyBurger.addHamburgerAddition1("Egg", 5.43);
		healthyBurger.addHealthAddition1("Lentils", 3.41);
		System.out.println("Total Healthy Burger price is  " + healthyBurger.printReceipt());
